    ...
    <div className=" w-full flex flex-col gap-5 font-['inter'] bg-[url('/src/assets/dashbg.png')] p-[50px]">
      ...
      <div className="flex w-full justify-between mb-8">
        <div className="bg-[#CCEDEF]  rounded-2xl p-[35px] relative w-[309px]">
          ...
          <button className="w-full bg-[#0251BA] text-white py-2 rounded-lg hover:bg-blue-600 transition-colors cursor-pointer">
            + Create Project
          </button>
        </div>
      ...
      <div className=" pt-[27px] pb-8 w-full  bg-white border border-[#A1A3AB80] shadow-[0px_1px_4px_0px_#00000040] rounded-2xl">
        <div className=" flex flex-col gap-5">
          ...
          <div className=" place-self-center">
            <h2 className=" text-[20px] font-medium text-center mb-2.5">Want to Explore First?</h2>
            <p className=" font-light text-[16px] text-center w-[570px]">You're currently viewing a clean dashboard. In the demo version, sample projects and tasks would appear here to help you explore TaskFlow's features.</p>
          </div>
          <div className=" text-[15px] font-medium flex gap-[42px] place-self-center">
            <button className=" text-white bg-[#05A301] px-[26.5px] py-2.5 rounded-lg shadow-[0px_1px_4px_0px_#00000040] cursor-pointer">+  Create Your First Project</button>
            <button className=" py-2.5 w-[247px] rounded-lg shadow-[0px_1px_4px_0px_#00000040] border border-[#05A301] text-[#05A301] cursor-pointer">+  Add A Task</button>
          </div>
        </div>
      </div>
    </div>
            ...
            <div className=" flex justify-evenly">
              <div className=" px-[23px] pt-[17px] pb-[26px] flex gap-[11px] border border-[#74747480] rounded-2xl">
                ...
                <div className=" text-[12px] font-['inter'] w-[201px]">
                  ...
                  <p >Use keyboard shortcuts: Press 'C' to create a new task quickly</p>
                </div>
              </div>
              <div className=" px-[23px] pt-[17px] pb-[26px] flex gap-[11px] border border-[#74747480] rounded-2xl">
                ...
                <div className=" text-[12px] font-['inter'] w-[201px]">
                  ...
                  <p >Set due dates and priorities to manage your workload effectively</p>
                </div>
              </div>
              <div className=" px-[23px] pt-[17px] pb-[26px] flex gap-[11px] border border-[#74747480] rounded-2xl">
                ...
                <div className=" text-[12px] font-['inter'] w-[201px]">
                  ...
                  <p >Invite team members to projects and assign tasks to stay in sync</p>
                </div>
              </div>
            </div>
          </div>
